...
Name:           ros-humble-as2-alphanumeric-viewer
Version:        0.2.2
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS as2_alphanumeric_viewer package
...
%changelog
* Thu Dec 22 2022 Javier Melero Deza <javier.mdeza@alumnos.upm.es> - 0.2.2-1
