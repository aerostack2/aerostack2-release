...
Name:           ros-humble-as2-platform-behaviors
Version:        0.2.2
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS as2_platform_behaviors package
...
%description
Aerostack2 core package which contains launchers for the basic behaviours
