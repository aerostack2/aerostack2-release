...
Name:           ros-humble-as2-controller-plugin-speed-controller
Version:        0.2.2
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS as2_controller_plugin_speed_controller package
...
%description
Controller plugin to control UAVs inside the Aerostack2 framework with speed
ouput reference
