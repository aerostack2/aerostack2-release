...
Name:           ros-humble-as2-controller-manager
Version:        0.2.2
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS as2_controller_manager package
...
%description
Controller manager package for managing the low-level controllers inside the
aerostack2 system
