...
Name:           ros-humble-as2-controller-plugin-differential-flatness
Version:        0.2.2
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS as2_controller_plugin_differential_flatness package

License:        BSD-3-Clause
Source0:        %{name}-%{version}.tar.gz

Requires:       eigen3-devel
Requires:       ros-humble-as2-controller-plugin-base
...
BuildRequires:  ros-humble-as2-controller-plugin-base
...
%description
Controller plugin to control UAVs inside the Aerostack2 framework with acro
ouput reference
